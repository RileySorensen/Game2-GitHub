...
void Bogo::SpriteAnimComponent::Update()
{
...
bool Bogo::SpriteAnimComponent::Write(const rapidjson::Value& value) const
{
    return true;
}

bool Bogo::SpriteAnimComponent::Read(const rapidjson::Value& value)
{
	{
